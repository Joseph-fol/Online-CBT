...
const TermsAndPolicy = () => {
    ...
    return (
            <div className="terms-policy-wrapper">
                ...
                {/* Header Section */}
                <div className='py-5 text-center terms-policy-header'>
                    <div className='container py-4'>
                        <h1 className='fw-bold display-4 mb-3 terms-policy-title'>Privacy Policy</h1>
                        {/* <p className='fs-5 text-secondary'>Last updated: May 22, 2026</p> */}
                    </div>
                </div>
                ...
                <div className='container py-5 flex-grow-1'>
                    <div className='row justify-content-center'>
                        <div className='col-lg-10 bg-white p-4 p-md-5 rounded-4 shadow-sm terms-content'>
                            <p className="lead mb-5 terms-content-lead">
                            ...
                            <ul>
                                ...
                                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Online CBT.</li>
                                ...
                                <li><strong>Website</strong> refers to Online CBT , accessible from <a href="https://onlinecbt.vercel.app" rel="external nofollow noopener" target="_blank">https://onlinecbt.vercel.app</a>.</li>
                            ...
                            <ul>
                                <li>By email: olawoyinjoseph05@gmail.com</li>
                                <li>By visiting this page on our website: <a href="https://onlinecbt.vercel.app" rel="external nofollow noopener" target="_blank">https://onlinecbt.vercel.app</a></li>
                                <li>By phone: 08125831469</li>
                            </ul>
                        </div>
                    </div>
                </div>
