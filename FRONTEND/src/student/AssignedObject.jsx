                ...
                <div className='container'>
                    <div style={subjectsAssigned}>
                        ...
                        <div className='fw-bold'>
                            <a href="" style={{ color: "#121d38" }} className='text-decoration-none'><span style={{ fontSize: " 14px" }}>View all curriculum </span></a> <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><g fill="none"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" /><path fill="#121d38" d="m15.06 5.283l5.657 5.657a1.5 1.5 0 0 1 0 2.12l-5.656 5.658a1.5 1.5 0 0 1-2.122-2.122l3.096-3.096H4.5a1.5 1.5 0 0 1 0-3h11.535L12.94 7.404a1.5 1.5 0 0 1 2.122-2.121Z" /></g></svg>
                        </div>
                    </div>
                </div>
                ...
                <div className='container'>
                    <div className='row g-4'>
                        <div className='col-12 col-md-4'>
                            <div>
                                <AssignedObjectCard
                                    ...
                                    description="Static analysis, material resilience, and modern architectural load-bearing."
                                    question="45 QUESTIONS"
                        ...
                        <div className='col-12 col-md-4'>
                            <div>
                                <AssignedObjectCard
                                    cardSvg={<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="#ab3500" d="M18 6H8.83l6 6l-6 6H18v2H6v-2l6-6l-6-6V4h12z" /></svg>}
                                    title="Applied Calculus IV"
                                    description="Multivariable integration, vector fields, and thermodynamic modeling."
                        ...
                        <div className='col-12 col-md-4'>
                            <div>
                                <AssignedObjectCard
                                    cardSvg={<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="#ab3500" d="m13.196 2.268l3.25 5.63a1 1 0 0 1-.366 1.365l-1.3.75l1.001 1.732l-1.732 1l-1-1.733l-1.299.751a1 1 0 0 1-1.366-.366L8.546 8.215a5 5 0 0 0-3.222 6.56A4.97 4.97 0 0 1 8 14c1.684 0 3.174.833 4.08 2.109l7.688-4.439l1 1.733l-7.878 4.548a5 5 0 0 1 .01 2.05L21 20v2l-17 .001A4.98 4.98 0 0 1 3 19c0-1.007.298-1.945.81-2.73a7.003 7.003 0 0 1 3.717-9.82l-.393-.682a2 2 0 0 1 .732-2.732l2.598-1.5a2 2 0 0 1 2.732.732M8 16a3 3 0 0 0-2.83 4h5.66A3 3 0 0 0 8 16m3.464-12.732l-2.598 1.5l2.75 4.763l2.598-1.5z" /></svg>}
                                    title="Molecular Biology"
                                    description="Advanced genetics, protein synthesis, and cellular replication mechanisms."
                        ...
                        <div className='col-12 col-md-4'>
                            <AssignedObjectCard
                                cardSvg={<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 32 32"><path fill="#ab3500" d="m20.17 19l-2.59 2.59L19 23l4-4l-4-4l-1.42 1.41zm-8.34 0l2.59-2.59L13 15l-4 4l4 4l1.42-1.41z" /><circle cx="9" cy="8" r="1" fill="#ab3500" /><circle cx="6" cy="8" r="1" fill="#ab3500" /><path fill="#ab3500" d="M28 4H4c-1.103 0-2 .898-2 2v20c0 1.103.897 2 2 2h24c1.103 0 2-.897 2-2V6c0-1.102-.897-2-2-2m0 2v4H4V6zM4 26V12h24v14z" /></svg>}
                                title="System Programming"
                                description="Memory management, kernel architecture, and low-level optimization in C/Rust."
